...
export class Department extends React.Component {
    ...
    refreshDepartmentList() {
        fetch(variables.API_URL + 'department')
            .then(res => res.json())
            .then(data => {
                this.setState({ deparments: data,departmentsWithoutFilter:data })
            })
    }
    ...
    updateClick(){
        fetch(variables.API_URL+'department/'+this.state.DepartmentId,{
            method:'PUT',
            headers:{
                'Accept':'application/json',
                'Content-Type':'application/json'
    ...
    render() {
        const { deparments,modalTitle,DepartmentName,DepartmentId } = this.state;
        return (
            <div>
                <button type="button"
