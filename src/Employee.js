...
export class Employee extends Component{
    ...
    changeDepartment =(e)=>{        
        ...
        this.setState({DepartmentId:e.target.options[selectedIndex].getAttribute('data-key')});
    }
    ...
    imageUpload=(e)=>{
        ...
        .then(res=>res.json())
        .then(data=>{
            console.log("photofilename"+data);
    ...
    <div className="d-flex flex-row bd-highlight mb-3">
     ...
     <div className="p-2 w-50 bd-highlight">
        ...
        <div className="input-group mb-3">
            ...
            value={Department}>
                {departments.map(dep=><option key={dep.id} data-key={dep.id}>
                    {dep.departmentName}
                </option>)}
            </select>
        </div>
